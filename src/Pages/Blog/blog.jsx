...
import { useGetCategoriesQuery, useDeleteCategoryMutation, useGetProfileQuery, useGetBlogQuery, useDeleteBlogMutation, } from "../../services/apiSlice";
...
const Category = () => {
    ...
    const { data: categories } = useGetBlogQuery({
        size: itemsPerPage,
        page: currentPage,
        search: searchTerm,
    });
    ...
    const handleDeleteCategory = async () => {
        try {
            ...
            formdata.append('post_id', deletcategory)

            await deleteblog(formdata).unwrap();
        ...
        <div>
            ...
            <div className='flex inter'>
                ...
                <div className="w-full width__right relative max-md:ms-0">
                    <SubHeader setIsOpenside={setIsOpenside} pageName={"Blog"} />
                    <div className="flex justify-between gap-[10px] mb-[27px] flex-wrap items-center max-sm:block" >
                        <h3 className="text-[22px] font-[700] text-[#707793] uppercase "> Blog</h3>
                        ...
                        <nav className="text-sm text-gray-600 max-sm:mt-[15px] max-sm:ps-[5px]" aria-label="Breadcrumb" >
                            <ol className="flex flex-wrap items-center ">
                                ...
                                <li className="text-[var(--blue)] font-medium text-[12px]">All Blog</li>
                            </ol>
                        </nav>
                    ...
                    <div className="border mt-[30px] bg-white border-[#EBE9F1] shadow-[0px_4px_24px_0px_#0000000F]  rounded-[10px]">
                        <div className="p-[20px] flex  gap-4 items-center justify-between">
                            ...
                            <div className="flex gap-2">
                                ...
                                <div>
                                    <Link to="/create_blog">
                                        <button className="bg-[var(--blue)] text-white text-[12.6px] rounded-[8px] py-[5.56px] px-[12px]">Add Blog</button>
                                    </Link>
                                </div>
                                <div>
                            ...
                            <table className="w-full ">
                                <thead className="border-y border-[#ddd]">
                                    ...
                                    <tr className="max-sm:h-[40px] h-[54px] ">
                                        ...
                                        <th className="text-[14px] font-bold text-center text-[#5d7186] sans text-nowrap max-lg:hidden max-md:text-[13px] max-sm:px-[10px]">Slug</th>
                                        <th className="text-[14px] font-bold text-center text-[#5d7186] sans text-nowrap max-md:text-[13px] max-sm:hidden max-sm:px-[10px]">Publish Date</th>
                                    ...
                                    {displayedData.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="text-sm text-[#5E5873] text-center px-[30px]  max-xl:px-[10px] max-sm:px-[5px] max-md:text-[12px]">
                                                <button
                                                    className={`px-[16px] py-1 rounded-[400px] ${item?.publish_blog == true
                                                        ? "bg-[#22c55e1a] text-[#22c55e]"
                                                        : "text-[var(--blue)] bg-[#ff6c2f1a] "
                                                        }`}
                                                >
                                                    {item?.publish_blog ? "Active" : "Inactive"}
                                                </button>
                                            </td>
                                            <td className="text-sm text-[#5E5873] text-center px-[30px] max-xl:px-[10px] max-sm:px-[5px]">
                                                <div className="flex gap-2 justify-center max-md:gap-1 max-sm:gap-0">
                                                    ...
                                                    <button className="w-[44px] h-[32px] max-md:h-[35px] max-md:w-[35px] max-sm:hidden bg-[#ff6c2f1a] flex justify-center items-center text-[var(--blue)] rounded-[0.5rem] hover:bg-[var(--blue)] hover:text-white" onClick={() => navigate("/edit_blog", { state: { post_id: item } })}>
                                                        <Icon icon="solar:pen-2-broken" className="align-middle h-[1.3em] w-[1.3em]" />
                                                    </button>
                                                    <button onClick={(e) => {
                                                        openModal('modal3')
                                                        e.stopPropagation(); // Prevent row click event
                                                        setDeletcategory(item.post_id)
                            ...
                            <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                                <div className="relative transform overflow-hidden p-[30px] border-t-[8px] border-[#F44336] rounded-[6px] bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl z-40">
                                    <div className="bg-white ">
                                        ...
                                        <p className="pt-[14px] text-[#8492A6]">Are you sure you want to delete this post?</p>
