...
const Create_category = () => {
    ...
    const handlesubmit = async () => {
        ...
        try {
            ...
            formData.append("category_img", file);
                        ...
                        <div className="flex justify-end items-center max-lg:justify-start">
                            <nav className="text-sm text-gray-600 max-sm:mt-[15px] max-sm:ps-[5px]" aria-label="Breadcrumb">
                                <ol className="flex flex-wrap items-center">
                                    ...
                                    <li className="flex items-center">
                                        <Link to="/dashboard" className="hover:text-[var(--blue)] font-[12px] text-[#575864]">Category</Link>
                                        <svg className="mx-2 h-4 w-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                            <path d="M9 5l7 7-7 7" />
                                        </svg>
                                    </li>
                                    <li className="text-[var(--blue)] font-medium text-[12px]">New Category</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                            ...
                                            {images.length === 0 ? (
                                                ...
                                                >
                                                    <div className="py-[32px] text-center">
                                                        <i className="fa-solid fa-cloud-arrow-up text-[var(--blue)] text-[3rem]" />
                                                        <h3 className="mt-[2.25rem] text-[24px] font-[600] text-[#313b5e] mb-[10px]">
                                                            Drop your images here, or{" "}
                                                            <span className="text-[var(--blue)]">click to browse</span>
                                                        </h3>
                                    ...
                                    <div className="mb-4 ">
                                        ...
                                        <div className="cursor-pointer flex items-center  max-sm:hidden">
                                            <div onClick={toggleHomeActive}
                                                className={`border-1 checkbox w-[20px] h-[20px] rounded-[4px] bg-[#eef2f7] flex items-center justify-center transition-colors ${homeActive ? 'bg-[#ff6c2f] border-[var(--blue)]' : ' border-[#ece7e7f1]'}`}>
                                            ...
                                            <div onClick={toggleHomeInactive}
                                                className={`border-1 checkbox w-[20px] h-[20px] rounded-[4px] bg-[#eef2f7] flex items-center justify-center transition-colors ${homeInactive ? 'bg-[#ff6c2f] border-[var(--blue)]' : ' border-[#ece7e7f1]'}`}>
