...
import { useGetCategoriesQuery, useDeleteCategoryMutation, useGetProfileQuery, useGetCartQuery, } from "../../services/apiSlice";
...
const Cart = () => {
    ...
    const { data: categories } = useGetCartQuery({
        size: itemsPerPage,
        page: currentPage,
        search: searchTerm,
    });
        ...
        <div>
            ...
            <div className='flex inter'>
                ...
                <div className="w-full width__right relative max-md:ms-0">
                    <SubHeader setIsOpenside={setIsOpenside} pageName={"Cart"} />
                    <div className="flex justify-between gap-[10px] mb-[27px] flex-wrap items-center max-sm:block" >
                        <h3 className="text-[22px] font-[700] text-[#707793] uppercase "> Cart</h3>
                        ...
                        <nav className="text-sm text-gray-600 max-sm:mt-[15px] max-sm:ps-[5px]" aria-label="Breadcrumb" >
                            <ol className="flex flex-wrap items-center ">
                                ...
                                <li className="text-primary font-medium text-[12px]"> Cart</li>
                            </ol>
                        </nav>
