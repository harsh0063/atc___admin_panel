...
import { useGetSubCategoriesQuery, useGetProfileQuery, useDeleteSubCategoryMutation, useGetCategoriesQuery, useGetCategories_fetch_allQuery } from "../../services/apiSlice";
...
const Category = () => {
    ...
    const [currentPage, setCurrentPage] = useState(() => {
        return parseInt(sessionStorage.getItem("sub_page") || "1");
    });
            ...
            <div className='flex inter'>
                ...
                <div className="w-full width__right relative max-md:ms-0">
                    ...
                    <div className="flex justify-between gap-[10px] mb-[27px] flex-wrap items-center max-sm:block" >
                        <h3 className="text-[22px] font-[700] text-[#707793] uppercase "> Sub Category</h3>
                        ...
                        <nav className="text-sm text-gray-600 max-sm:mt-[15px] max-sm:ps-[5px]" aria-label="Breadcrumb" >
                            <ol className="flex flex-wrap items-center ">
                                ...
                                <li className="text-primary font-medium text-[12px]">All Sub Category</li>
                            </ol>
                        </nav>
                    ...
                    <div className="border mt-[30px] bg-white border-[#EBE9F1] shadow-[0px_4px_24px_0px_#0000000F]  rounded-[10px]">
                        <div className="p-[20px] flex  gap-4 items-center justify-between">
                            <div className="flex flex-col lg:flex-row lg:items-center gap-3 w-full lg:w-auto">
                                ...
                                <div>
                                    <h3 className="font-[600] text-[16px] text-[#313b5e] hans">All Sub Categories List</h3>
                                </div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <div>
                                    <Link to="/create_subcategory">
                                        <button className="bg-[#ff6c2f] text-white text-[12.6px] rounded-[8px] py-[5.56px] px-[12px]">Add Sub Category</button>
                                    </Link>
                                </div>
                                <div>
                            ...
                            <table className="w-full ">
                                <thead className="border-y border-[#ddd]">
                                    ...
                                    <tr className="max-sm:h-[40px] h-[54px] ">
                                        ...
                                        <th className="text-[14px] font-bold text-center text-[#5d7186] sans text-nowrap max-lg:hidden max-md:text-[13px] max-sm:px-[10px]">Category</th>
                                        ...
                                        <tr
                                            ...
                                            onClick={() => {
                                                if (window.innerWidth <= 640) {
                                                    sessionStorage.setItem("sub_page", currentPage)
                                                    navigate("/edit_subcategory", { state: { subcategory_id: item } })
                                                }
                                            }
                                            }
                                        >
                                            <td className="text-sm text-[#5E5873] flex  px-[30px] max-xl:px-[10px] max-sm:px-[5px] max-sm:min-w-[120px]   items-center gap-2 my-[15px] max-md:gap-1 max-md:text-[12px]">
                                                ...
                                                <div className="h-[56px] min-w-[56px] max-md:min-w-[40px] max-md:max-h-[40px] bg-[#eef2f7] rounded-[12px] flex items-center justify-center overflow-hidden">
                                                    <img
                                                        src={`${import.meta.env.VITE_API_BASE_URL}${item.subcategory_img}`}
                                                        alt="category_img"
                                            ...
                                            <td className="text-sm text-[#5E5873] text-center px-[30px] max-xl:px-[10px] max-sm:px-[5px] max-lg:hidden max-md:text-[12px]">
                                                ...
                                                {cate?.data?.find((val) => val.category_id == item.category)?.name}
                                            </td>
                                            ...
                                            <td className="text-sm text-[#5E5873] text-center px-[30px] max-xl:px-[10px] max-sm:px-[5px]">
                                                <div className="flex gap-2 justify-center max-md:gap-1 max-sm:gap-0">
                                                    ...
                                                    <button className="w-[44px] h-[32px] max-md:h-[35px] max-md:w-[35px] max-sm:hidden bg-[#ff6c2f1a] flex justify-center items-center text-primary rounded-[0.5rem] hover:bg-primary hover:text-white" onClick={() => { sessionStorage.setItem("sub_page", currentPage); navigate("/edit_subcategory", { state: { subcategory_id: item } }) }}>
                                                        <Icon icon="solar:pen-2-broken" className="align-middle h-[1.3em] w-[1.3em]" />
                                                    </button>
                                                    <button onClick={(e) => {
                                                        openModal('modal3')
                                                        e.stopPropagation(); // Prevent row click event
                                                        setDeletcategory(item.subcategory_id)
                            ...
                            <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                                <div className="relative transform overflow-hidden p-[30px] border-t-[8px] border-[#F44336] rounded-[6px] bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl z-40">
                                    ...
                                    <div className="  pt-[30px] flex flex-row-reverse gap-3 ">
                                        <button type="button" onClick={handledeletesubcategory} className="inline-flex h-[35px] sm:h-[40px]  w-[114px] shadow-[0px_8px_20px_1px_#F443364D] rounded-md bg-[#F44336] items-center   justify-center py-2 text-sm font-semibold text-white shadow-xs  sm:ml-3 ">Delete</button>
